...
conf['params']['lat-sys']={}
#--pITD systematics
conf['params']['lat-sys']['alpha-pITD']  ={'value':-0.5, 'min':  -1, 'max':  1, 'fixed': False} #--jacobi polynomial parameter
conf['params']['lat-sys']['beta-pITD']   ={'value': 1.0, 'min':  -1, 'max': 10, 'fixed': False} #--jacobi polynomial parameter
conf['params']['lat-sys']['b1-pITD']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--higher-twist effect
conf['params']['lat-sys']['b1-pITD']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--higher-twist effect
conf['params']['lat-sys']['p1-pITD']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['r1-pITD']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['m1-pITD']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--pion mass effect
conf['params']['lat-sys']['f1-pITD']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--finite volume effect
#--ccLCS systematics
conf['params']['lat-sys']['alpha-ccLCS']  ={'value':-0.5, 'min':  -1, 'max':  1, 'fixed': False} #--jacobi polynomial parameter
conf['params']['lat-sys']['beta-ccLCS']   ={'value': 1.0, 'min':  -1, 'max': 10, 'fixed': False} #--jacobi polynomial parameter
conf['params']['lat-sys']['b1-ccLCS']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--higher-twist effect
conf['params']['lat-sys']['b1-ccLCS']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--higher-twist effect
conf['params']['lat-sys']['p1-ccLCS']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['r1-ccLCS']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['m1-ccLCS']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--pion mass effect
conf['params']['lat-sys']['f1-ccLCS']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--finite volume effect
