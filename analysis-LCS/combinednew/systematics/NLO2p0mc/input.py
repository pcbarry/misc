...
conf['params']['lat-sys']={}
conf['params']['lat-sys']['cL-pITD']  ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False} #--FV effect pITD
conf['params']['lat-sys']['cL-ccLCS'] ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False} #--FV effect ccLCS
conf['params']['lat-sys']['b1-mpi']   ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False} #--pion mass effect
conf['params']['lat-sys']['b2-a']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False} #--lattice spacing effect
...
conf['steps'][18]['active distributions']=['pdf-pion','p->pi,n','lat-sys','pdf']
...
conf['steps'][18]['datasets']['pITD']=[]
conf['steps'][18]['datasets']['pITD'].append(1001)
conf['steps'][18]['datasets']['pITD'].append(1002)
conf['steps'][18]['datasets']['ccLCS']=[]
conf['steps'][18]['datasets']['ccLCS'].append(12781)
conf['steps'][18]['datasets']['ccLCS'].append(13581)
conf['steps'][18]['datasets']['ccLCS'].append(14131)
conf['steps'][18]['datasets']['ccLCS'].append(14132)
