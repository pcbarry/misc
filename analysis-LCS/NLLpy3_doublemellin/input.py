...
conf['params']['pdf-pion']['g1 a']   ={'value':    -9.048e-01, 'min': -1.9 , 'max':    12,'fixed':False}
...
conf['params']['pdf-pion']['ubv1 c'] ={'value':           0.0, 'min':  -1.0, 'max':   100,'fixed':False}#,'zero':True}
...
conf['params']['pdf-pion']['dv1 c'] ={'value':            0.0, 'min':-100.0, 'max':   100,'fixed':'ubv1 c'}
...
conf['params']['pdf-pion']['u1 a']   ={'value':    -7.228e-01, 'min': -1.9 , 'max':    12,'fixed':False}
...
conf['steps'][17]['active distributions']=['pdf-pion']
conf['steps'][17]['fix parameters']={}
conf['steps'][17]['fix parameters']['pdf-pion']=['g1 N','g1 a','g1 b','u1 a','u1 b']
...
#--dy
conf['steps'][18]={}
conf['steps'][18]['dep']=[10,16,17]
conf['steps'][18]['active distributions']=['pdf-pion','p->pi,n','pdf']
# conf['steps'][18]['passive distributions']=['pdf']
conf['steps'][18]['datasets']={}
conf['steps'][18]['datasets']['dy-pion']=[]
conf['steps'][18]['datasets']['dy-pion'].append(10001)
conf['steps'][18]['datasets']['dy-pion'].append(10002)
conf['steps'][18]['datasets']['dy-pion'].append(10003)
# conf['steps'][18]['datasets']['ln']=[]
# conf['steps'][18]['datasets']['ln'].append(1000)
# conf['steps'][18]['datasets']['ln'].append(2000)

##--dy+ln
#conf['steps'][19]={}
#conf['steps'][19]['dep']=[10,18]
#conf['steps'][19]['active distributions']=['pdf-pion','p->pi,n','pdf']
#conf['steps'][19]['passive distributions']=['pdf']
#conf['steps'][19]['datasets']={}
#conf['steps'][19]['datasets']['dy-pion']=[]
#conf['steps'][19]['datasets']['dy-pion'].append(10001)
#conf['steps'][19]['datasets']['dy-pion'].append(10002)
#conf['steps'][19]['datasets']['dy-pion'].append(10003)
#conf['steps'][19]['datasets']['ln']=[]
#conf['steps'][19]['datasets']['ln'].append(1000)
#conf['steps'][19]['datasets']['ln'].append(2000)
