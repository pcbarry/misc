...
#--Finite Volume effect parameter -- pITD
conf['params']['FV']={}
#conf['params']['FV']['cL']={'value': -0.11, 'min': -10, 'max': 10, 'fixed': False}
conf['params']['FV']['cL']={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True}
...
conf['steps'][18]['datasets']['pion_qT']=[]
conf['steps'][18]['datasets']['pion_qT'].append(1001)
conf['steps'][18]['datasets']['pion_qT'].append(1002)
...
#conf['steps'][19]['active distributions']=['pdf-pion','p->pi,n','FV','pdf']
...
#conf['steps'][19]['datasets']['pITD']=[]
#conf['steps'][19]['datasets']['pITD'].append(1001)
#conf['steps'][19]['datasets']['pITD'].append(1002)
conf['steps'][19]['datasets']['ccLCS']=[]
conf['steps'][19]['datasets']['ccLCS'].append(12781)
conf['steps'][19]['datasets']['ccLCS'].append(13581)
conf['steps'][19]['datasets']['ccLCS'].append(14131)
conf['steps'][19]['datasets']['ccLCS'].append(14132)
