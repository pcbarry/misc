...
conf['datasets']['ccLCS']['xlsx'][22781]='current-current-pion/expdata/22781.xlsx' #--a=0.094,mpi=278,L=32
conf['datasets']['ccLCS']['xlsx'][23581]='current-current-pion/expdata/23581.xlsx' #--a=0.094,mpi=358,L=32
conf['datasets']['ccLCS']['xlsx'][24131]='current-current-pion/expdata/24131.xlsx' #--a=0.127,mpi=413,L=32
conf['datasets']['ccLCS']['xlsx'][24132]='current-current-pion/expdata/24132.xlsx' #--a=0.127,mpi=413,L=24
...
conf['params']['lat-sys']['b0-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--higher-twist effect
conf['params']['lat-sys']['p0-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['r0-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['m0-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--pion mass effect
conf['params']['lat-sys']['f0-ccLCS']     ={'value': 0.0, 'min': -50, 'max': 50, 'fixed': True, 'zero':True} #--finite volume effect
conf['params']['lat-sys']['b1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--higher-twist effect
conf['params']['lat-sys']['p1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['r1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['m1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--pion mass effect
conf['params']['lat-sys']['f1-ccLCS']     ={'value': 0.0, 'min':-100, 'max':100, 'fixed': True, 'zero':True} #--finite volume effect
conf['params']['lat-sys']['b2-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--higher-twist effect
conf['params']['lat-sys']['p2-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['r2-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['m2-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--pion mass effect
conf['params']['lat-sys']['f2-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--finite volume effect
...
#conf['steps'][17]['datasets']['ccLCS'].append(22781)
#conf['steps'][17]['datasets']['ccLCS'].append(23581)
#conf['steps'][17]['datasets']['ccLCS'].append(24131)
#conf['steps'][17]['datasets']['ccLCS'].append(24132)
