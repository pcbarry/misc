...
#--ccLCS systematics
conf['params']['lat-sys']['cL-ccLCS'] ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True} #--FV effect ccLCS
conf['params']['lat-sys']['b1-mpi']   ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True} #--pion mass effect
conf['params']['lat-sys']['b2-a']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True} #--lattice spacing effect
