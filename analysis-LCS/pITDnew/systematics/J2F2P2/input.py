...
conf['params']['lat-sys']['p2-pITD']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--lattice spacing effect
...
conf['params']['lat-sys']['f2-pITD']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': False, 'zero':True} #--finite volume effect
#--ccLCS systematics
