...
conf['params']['lat-sys']['f0-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--finite volume effect
...
conf['params']['lat-sys']['f1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': True, 'zero':True} #--finite volume effect
