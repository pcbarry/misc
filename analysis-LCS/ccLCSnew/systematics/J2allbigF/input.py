...
conf['params']['lat-sys']['b1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False, 'zero':True} #--higher-twist effect
conf['params']['lat-sys']['p1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['r1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['m1-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False, 'zero':True} #--pion mass effect
...
conf['params']['lat-sys']['p2-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['r2-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False, 'zero':True} #--lattice spacing effect
conf['params']['lat-sys']['m2-ccLCS']     ={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False, 'zero':True} #--pion mass effect
