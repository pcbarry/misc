...
conf['params']['lat-sys']['beta-pITD']   ={'value': 1.0, 'min':  -1, 'max': 10, 'fixed': True} #--jacobi polynomial parameter
...
conf['params']['lat-sys']['b0-ccLCS']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': True, 'zero':True} #--higher-twist effect
...
conf['params']['lat-sys']['f0-ccLCS']     ={'value': 0.0, 'min':  -1, 'max':  1, 'fixed': True, 'zero':True} #--finite volume effect
