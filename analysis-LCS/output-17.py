...
conf['datasets']['ln']['norm'][1000]={'value':    1.20425e+00,'fixed':False,'min':0.5,'max':1.5}
conf['datasets']['ln']['norm'][2000]={'value':    9.68022e-01,'fixed':False,'min':0.5,'max':1.5}
...
conf['datasets']['dy-pion']['norm'][10001]={'value':    1.10343e+00,'fixed':False,'min':   0.5,'max':    1.5}
conf['datasets']['dy-pion']['norm'][10002]={'value':    9.01131e-01,'fixed':False,'min':   0.5,'max':    1.5}
conf['datasets']['dy-pion']['norm'][10003]={'value':    8.43201e-01,'fixed':False,'min':   0.5,'max':    1.5}
...
conf['params']['pdf']['g1 N']    ={'value':    3.76121e-01, 'min':  None, 'max':  None, 'fixed': True }
conf['params']['pdf']['g1 a']    ={'value':   -6.22140e-01, 'min':  -1.9, 'max':     1, 'fixed': True}
conf['params']['pdf']['g1 b']    ={'value':    9.18244e+00, 'min':     0, 'max':    10, 'fixed': True}

conf['params']['pdf']['uv1 N']   ={'value':    3.44587e-01, 'min':  None, 'max':  None, 'fixed': True }
conf['params']['pdf']['uv1 a']   ={'value':   -1.23077e-01, 'min':  -0.5, 'max':     1, 'fixed': True}
conf['params']['pdf']['uv1 b']   ={'value':    3.21279e+00, 'min':     0, 'max':    10, 'fixed': True}

conf['params']['pdf']['dv1 N']   ={'value':    1.33500e-01, 'min':  None, 'max':  None, 'fixed': True }
conf['params']['pdf']['dv1 a']   ={'value':   -2.60024e-01, 'min':  -0.5, 'max':     1, 'fixed': True}
conf['params']['pdf']['dv1 b']   ={'value':    3.80293e+00, 'min':     0, 'max':    10, 'fixed': True}

conf['params']['pdf']['db1 N']   ={'value':    3.61716e-02, 'min':     0, 'max':     1, 'fixed': True}
conf['params']['pdf']['db1 a']   ={'value':   -8.28192e-01, 'min':    -1, 'max':     1, 'fixed': True}
conf['params']['pdf']['db1 b']   ={'value':    5.32275e+00, 'min':     0, 'max':    10, 'fixed': True}

conf['params']['pdf']['ub1 N']   ={'value':    1.82924e-02, 'min':     0, 'max':     1, 'fixed': True}
conf['params']['pdf']['ub1 a']   ={'value':   -1.00000e+00, 'min':    -1, 'max':     1, 'fixed': True}
conf['params']['pdf']['ub1 b']   ={'value':    8.97677e+00, 'min':     0, 'max':    10, 'fixed': True}

conf['params']['pdf']['s1 N']    ={'value':    2.26277e-27, 'min':     0, 'max':     1, 'fixed': True }
conf['params']['pdf']['s1 a']    ={'value':   -4.93525e-01, 'min':  -0.5, 'max':     1, 'fixed': True}
conf['params']['pdf']['s1 b']    ={'value':    9.97565e+00, 'min':     0, 'max':    10, 'fixed': True}

conf['params']['pdf']['sb1 N']   ={'value':    2.90270e-26, 'min':     0, 'max':     1, 'fixed': True}
conf['params']['pdf']['sb1 a']   ={'value':    9.30522e-01, 'min':  -0.5, 'max':     1, 'fixed': True}
conf['params']['pdf']['sb1 b']   ={'value':    4.81235e-01, 'min':     0, 'max':    10, 'fixed': True}

conf['params']['pdf']['sea1 N']  ={'value':    6.14417e-03, 'min':     0, 'max':     1, 'fixed': True}
conf['params']['pdf']['sea1 a']  ={'value':   -1.36600e+00, 'min':  -1.9, 'max':    -1, 'fixed': True}
conf['params']['pdf']['sea1 b']  ={'value':    3.27195e+00, 'min':     0, 'max':    10, 'fixed': True}

conf['params']['pdf']['sea2 N']  ={'value':    6.14417e-03, 'min':     0, 'max':     1, 'fixed': 'sea1 N'}
conf['params']['pdf']['sea2 a']  ={'value':   -1.36600e+00, 'min':  -1.9, 'max':    -1, 'fixed': 'sea1 a'}
conf['params']['pdf']['sea2 b']  ={'value':    3.27195e+00, 'min':     0, 'max':    10, 'fixed': 'sea1 b'}
...
conf['params']['ppdf']['g1 N']    ={'value':    3.76121e-01, 'min':   -10, 'max':    10, 'fixed': False}
conf['params']['ppdf']['g1 a']    ={'value':   -6.22140e-01, 'min':    -1, 'max':     2, 'fixed': False}
conf['params']['ppdf']['g1 b']    ={'value':    9.18244e+00, 'min':     0, 'max':    10, 'fixed': False}
...
conf['params']['pdf-pion']['g1 N']   ={'value':    2.72950e-01, 'min':  0.0 , 'max':    10,'fixed':False}
conf['params']['pdf-pion']['g1 a']   ={'value':   -6.88126e-01, 'min': -1.9 , 'max':     1,'fixed':False}
conf['params']['pdf-pion']['g1 b']   ={'value':    1.43469e+01, 'min':  0.0 , 'max':   100,'fixed':False}

conf['params']['pdf-pion']['ubv1 N'] ={'value':    2.75359e-01, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['ubv1 a'] ={'value':   -2.53137e-01, 'min': -0.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['ubv1 b'] ={'value':    9.65466e-01, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-pion']['dv1 N']  ={'value':    2.75359e-01, 'min':  0.0 , 'max':    10,'fixed':'ubv1 N'}
conf['params']['pdf-pion']['dv1 a']  ={'value':   -2.53137e-01, 'min': -1.8 , 'max':    10,'fixed':'ubv1 a'}
conf['params']['pdf-pion']['dv1 b']  ={'value':    9.65466e-01, 'min':  0.0 , 'max':    10,'fixed':'ubv1 b'}

conf['params']['pdf-pion']['u1 N']   ={'value':    2.93888e-02, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['u1 a']   ={'value':   -5.34492e-01, 'min': -1.9 , 'max':     1,'fixed':False}
conf['params']['pdf-pion']['u1 b']   ={'value':    6.66310e+00, 'min':  0.0 , 'max':   100,'fixed':False}

conf['params']['pdf-pion']['db1 N']  ={'value':    2.93888e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['db1 a']  ={'value':   -5.34492e-01, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['db1 b']  ={'value':    6.66310e+00, 'min':  0.0 , 'max':   100,'fixed':'u1 b'}

conf['params']['pdf-pion']['s1 N']   ={'value':    2.93888e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['s1 a']   ={'value':   -5.34492e-01, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['s1 b']   ={'value':    6.66310e+00, 'min':  0.0 , 'max':   100,'fixed':'u1 b'}

conf['params']['pdf-pion']['sb1 N']  ={'value':    2.93888e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['sb1 a']  ={'value':   -5.34492e-01, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['sb1 b']  ={'value':    6.66310e+00, 'min':  0.0 , 'max':   100,'fixed':'u1 b'}

#--LN parameter
conf['params']['p->pi,n']={}
conf['ln parametrization']=0
conf['params']['p->pi,n']['lambda']={'value':    1.28361e+00, 'min': 0.0, 'max': 2.0, 'fixed': False}
