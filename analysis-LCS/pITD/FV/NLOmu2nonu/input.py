...
#--setup for LCS
#--0: mu**2=(2GeV)**2, 1: mu**2=(4GeV)**2, 2: mu**2=conf['Q20']
conf['LCS scale']=0
conf['FV nu exp']=0
...
#--Finite Volume effect parameter -- LCS
conf['params']['FV']={}
#conf['params']['FV']['cL']={'value': -0.11, 'min': -10, 'max': 10, 'fixed': False}
conf['params']['FV']['cL']={'value': 0.0, 'min': -10, 'max': 10, 'fixed': False}
...
conf['steps'][18]['active distributions']=['pdf-pion','p->pi,n','FV','pdf']
