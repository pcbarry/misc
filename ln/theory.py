...
class LN:
  ...
  def __init__(self):
    ...
    elif self.model=='cov dip':      self.tgrandN = lambda y,t,kT2: pointN(y,t,kT2) * ((self.L_p2pin**2-mPi2)/(self.L_p2pin**2-t))**4
  ...
  def get_dsigdxdQ2dxL(self,x,xpi,y,Q2,kT2max,ye):
