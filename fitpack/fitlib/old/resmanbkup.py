...
#--from qcdlib
from qcdlib import pdf0,pdf1,pdf2,pdf3
from qcdlib import ppdf0,ppdf3
from qcdlib import ff0
from qcdlib import pdfpion0,pdfpion1,pdfpionsea,pdfpionNOMSR
from qcdlib import aux, eweak,ht0,ht1, alphaS, mellin, offshell
...
class RESMAN:
    ...
    def setup_core(self):
        ...
        if 'pdf-pion parametrization' in conf:
            ...
            if conf['pdf-pion parametrization']=='no msr': conf['pdf-pion']= pdfpionNOMSR.PDF()
