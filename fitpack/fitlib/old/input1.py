...
conf['datasets']['dy-pion']['filters'].append("xF<0.6") 
...
conf['pdf-pion parametrization']=1

conf['params']['pdf-pion']['g1 N']   ={'value':   5.03895e+00, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['g1 a']   ={'value':    -9.048e-01, 'min': -1.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['g1 b']   ={'value':   7.68225e+00, 'min':  5.0 , 'max':    10,'fixed':False}
...
conf['params']['pdf-pion']['u1 N']   ={'value':             0, 'min':  0.0 , 'max': 0.166,'fixed':False}
conf['params']['pdf-pion']['u1 a']   ={'value':    -7.228e-01, 'min': -1.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['u1 b']   ={'value':    5.5854e+00, 'min':  5.0 , 'max':    10,'fixed':False}

conf['params']['pdf-pion']['db1 N']  ={'value':    2.6720e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['db2 a']  ={'value':    -7.228e-01, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
