...
class FF: 
  ...
  def get_moments(self,flav,N=None):
    mom=conf['ffpion'].get_moments(flav,N)+conf['ffkaon'].get_moments(flav,N)
    return mom 
      ...
      for flav in conf['ffpion'].storage[Q2]:
        if flav == 'vm' or flav == 'vp':
          ...
          for i in conf['ffpion'].storage[Q2][flav]:
            self.storage[Q2][flav][i]=conf['ffpion'].storage[Q2][flav][i]+conf['ffkaon'].storage[Q2][flav][i]
        else: 
          self.storage[Q2][flav]=conf['ffpion'].storage[Q2][flav]+conf['ffkaon'].storage[Q2][flav]
