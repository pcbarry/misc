...
#--fitting setups
conf['bootstrap']=True
conf['flat par']=True #--if Dy_only==True (if not using previous dy priors), else==False
conf['ftol']=1e-10
...
conf['datasets']['ln']['xlsx'][20001]='ln/expdata/20001.xlsx' 
...
conf['datasets']['ln']['norm'][20001]={'value':       1,'fixed':True,'min':0.5,'max':1.5}

##--LH
conf['datasets']['lh']={}
conf['datasets']['lh']['filters']=[]
conf['datasets']['lh']['filters'].append("y<0.2") 
conf['datasets']['lh']['xlsx']={}
conf['datasets']['lh']['xlsx'][10001]='lh/expdata/10001.xlsx' 
conf['datasets']['lh']['xlsx'][10002]='lh/expdata/10002.xlsx' 
conf['datasets']['lh']['xlsx'][10003]='lh/expdata/10003.xlsx' 
conf['datasets']['lh']['norm']={}
conf['datasets']['lh']['norm'][10001]={'value':       1,'fixed':True,'min':0.5,'max':1.5}
conf['datasets']['lh']['norm'][10002]={'value':       1,'fixed':True,'min':0.5,'max':1.5}
conf['datasets']['lh']['norm'][10003]={'value':       1,'fixed':True,'min':0.5,'max':1.5}
...
conf['params']['pdf-pion']['g1 N']   ={'value':   5.03895e+00, 'min':  0.0 , 'max':    10,'fixed':False}
conf['params']['pdf-pion']['g1 a']   ={'value':    -9.048e-01, 'min': -1.9 , 'max':     1,'fixed':False}
...
conf['params']['pdf-pion']['u1 a']   ={'value':    -7.228e-01, 'min': -1.9 , 'max':     1,'fixed':False}
...
#--pdf-kaon parameters
conf['params']['pdf-kaon']={}
conf['pdf-kaon parametrization']=0

conf['params']['pdf-kaon']['g1 N']   ={'value':   5.03895e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['pdf-kaon']['g1 a']   ={'value':    -9.048e-01, 'min': -1.9 , 'max':     1,'fixed':False}
conf['params']['pdf-kaon']['g1 b']   ={'value':   7.68225e+00, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-kaon']['ubv1 N'] ={'value':     1.175e+00, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-kaon']['ubv1 a'] ={'value':    -2.914e-01, 'min': -0.9 , 'max':     0,'fixed':False}
conf['params']['pdf-kaon']['ubv1 b'] ={'value':     9.202e-01, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-kaon']['sv1 N']  ={'value':     1.175e+00, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-kaon']['sv1 a']  ={'value':    -2.914e-01, 'min': -0.9 , 'max':     0,'fixed':False}
conf['params']['pdf-kaon']['sv1 b']  ={'value':     9.202e-01, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-kaon']['u1 N']   ={'value':             0, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-kaon']['u1 a']   ={'value':    -7.228e-01, 'min': -1.9 , 'max':     1,'fixed':False}
conf['params']['pdf-kaon']['u1 b']   ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-kaon']['d1 N']   ={'value':     1.175e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-kaon']['d1 a']   ={'value':     2.914e-01, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-kaon']['d1 b']   ={'value':     9.202e-01, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}

conf['params']['pdf-kaon']['db1 N']  ={'value':    2.6720e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-kaon']['db1 a']  ={'value':    -7.228e-01, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-kaon']['db1 b']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}

conf['params']['pdf-kaon']['sb1 N']  ={'value':    2.6720e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-kaon']['sb1 a']  ={'value':    -7.228e-01, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-kaon']['sb1 b']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}
...
#--LH parameter
conf['params']['p->K,Lam']={}
conf['lh parametrization']=0
conf['params']['p->K,Lam']['lambda']={'value': 1.1e+00, 'min': 0.0, 'max': 2.0, 'fixed': False}
...
conf['steps'][17]['datasets']['ln'].append(20001)
conf['steps'][17]['datasets']['pion_qT']=[]
conf['steps'][17]['datasets']['pion_qT'].append(1001)
conf['steps'][17]['datasets']['pion_qT'].append(1002)

#--Kaon EIC pseudodata
conf['steps'][18]={}
conf['steps'][18]['dep']=[]
conf['steps'][18]['active distributions']=['pdf-kaon','p->K,Lam']
conf['steps'][18]['datasets']={}
conf['steps'][18]['datasets']['lh']=[]
#conf['steps'][18]['datasets']['lh'].append(10001)
#conf['steps'][18]['datasets']['lh'].append(10002)
conf['steps'][18]['datasets']['lh'].append(10003)
