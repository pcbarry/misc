...
def get_xQ2_grid(option=0,rs=None,nx=10,nQ2=10):
...
def gen_idis_xlsx(wdir,idx,tar,obs,X,Q2,rs=None):
    """
...
def gen_sim_idis_xlsx(wdir,dirname,iset,iF2,iFL,iF3,data,idx,lum):
