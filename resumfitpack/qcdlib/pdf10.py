...
class PDF: 
  ...
  def set_params(self):
      ...
      params['mix']   =np.array([1,-0.5,0,0,0])
  ...
  def set_sumrules(self):
      ...
      self.params['mix'][0]*=self.params['uv1'][0]
      self.params['mix'][1]+=self.params['uv1'][1]
      self.params['mix'][2:]=np.copy(self.params['uv1'][2:])

      self.params['dv1'][0]=1    
      dv=self.get_moments('dv1',1)+self.get_moments('mix',1)
      self.params['dv1'][0]=1/dv
      self.params['mix'][0]*=self.params['dv1'][0]
      ...
      dv=self.get_moments('dv1',2)+self.get_moments('mix',2)
  ...
  def set_moms(self):
      ...
      moms['dp'] = dv+2*(sea1+self.get_moments('db1'))
...
if __name__=='__main__':
  ...
  for _ in pdf.sr: print(_,pdf.sr[_])
