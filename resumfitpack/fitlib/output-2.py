...
conf['datasets']['ln']['norm'][1000]={'value':    1.01173e+00,'fixed':False,'min':0.5,'max':1.5}
...
conf['datasets']['dy-pion']['norm'][10001]={'value':    1.38479e+00,'fixed':False,'min':   0.5,'max':    1.5}
...
conf['params']['pdf-pion']['g1 N']   ={'value':    1.01219e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['pdf-pion']['g1 a']   ={'value':   -1.89441e+00, 'min': -1.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['g1 b']   ={'value':    1.26914e+00, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-pion']['ubv1 N'] ={'value':    2.71356e-01, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['ubv1 a'] ={'value':   -7.83750e-14, 'min': -0.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['ubv1 b'] ={'value':    1.68519e+00, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-pion']['dv1 N']  ={'value':    2.71356e-01, 'min':  0.0 , 'max':    10,'fixed':'ubv1 N'}
conf['params']['pdf-pion']['dv1 a']  ={'value':   -7.83750e-14, 'min': -1.8 , 'max':    10,'fixed':'ubv1 a'}
conf['params']['pdf-pion']['dv1 b']  ={'value':    1.68519e+00, 'min':  0.0 , 'max':    10,'fixed':'ubv1 b'}

conf['params']['pdf-pion']['u1 N']   ={'value':    5.93448e-02, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['u1 a']   ={'value':   -1.07104e+00, 'min': -1.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['u1 b']   ={'value':    1.69690e+00, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-pion']['db1 N']  ={'value':    5.93448e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['db1 a']  ={'value':   -1.07104e+00, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['db1 b']  ={'value':    1.69690e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}

conf['params']['pdf-pion']['s1 N']   ={'value':    5.93448e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['s1 a']   ={'value':   -1.07104e+00, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['s1 b']   ={'value':    1.69690e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}

conf['params']['pdf-pion']['sb1 N']  ={'value':    5.93448e-02, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['sb1 a']  ={'value':   -1.07104e+00, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['sb1 b']  ={'value':    1.69690e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}

#--LN parameter
conf['params']['p->pi,n']={}
conf['ln parametrization']=0
conf['params']['p->pi,n']['lambda']={'value':    1.13724e+00, 'min': 0.0, 'max': 2.0, 'fixed': False}
