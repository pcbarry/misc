...
conf['params']['pdf-pion']['g1 N']   ={'value':   2.97220e-01, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['pdf-pion']['g1 a']   ={'value':    -9.182e-01, 'min': -1.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['g1 b']   ={'value':   7.85701e+00, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-pion']['ubv1 N'] ={'value':     1.175e+00, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['ubv1 a'] ={'value':    -3.345e-01, 'min': -0.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['ubv1 b'] ={'value':     8.369e-01, 'min':  0.0 , 'max':    10,'fixed':False}
conf['params']['pdf-pion']['ubv1 c'] ={'value':           0.0, 'min':-10.0 , 'max':    10,'fixed':False,'zero':True}
...
conf['params']['pdf-pion']['dv1 c']  ={'value':           0.0, 'min':-10.0 , 'max':    10,'fixed':'ubv1 c'}
conf['params']['pdf-pion']['dv1 d']  ={'value':           2.0, 'min':  0.0 , 'max':    10,'fixed':'ubv1 d'}

conf['params']['pdf-pion']['u1 N']   ={'value':             0, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['u1 a']   ={'value':    -7.500e-01, 'min': -1.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['u1 b']   ={'value':    5.3546e+00, 'min':  0.0 , 'max':    10,'fixed':False}
...
conf['params']['pdf-pion']['s1 b']   ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}
...
conf['params']['pdf-pion']['sb1 b']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}
