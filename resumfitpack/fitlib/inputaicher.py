...
conf['flat par']=False #--if Dy_only==True (if not using previous dy priors), else==False
conf['ftol']=1e-8
...
#--setups for DY-qT
#--0: mu=Q, 1: mu=pT/2, 2: mu = pT, 3: mu = 2pT
conf['dy_pT_scale'] = 1
...
conf['datasets']['dy-pion']['filters'].append("Q2>4.03**2")
conf['datasets']['dy-pion']['filters'].append("Q2<8.53**2")
#conf['datasets']['dy-pion']['filters'].append("Q2<7.5**2")
conf['datasets']['dy-pion']['filters'].append("xF>0") 
conf['datasets']['dy-pion']['filters'].append("xF<0.8") 
#conf['datasets']['dy-pion']['filters'].append("xF<0.8") 
...
conf['pdf-pion parametrization']='resum'

conf['params']['pdf-pion']['g1 N']   ={'value':          5.90, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['g1 a']   ={'value':     1.270-1.0, 'min': -1.9 , 'max':     2,'fixed':True}
conf['params']['pdf-pion']['g1 b']   ={'value':         1.290, 'min':  5.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['g1 c']   ={'value':        -2.074, 'min': -5.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['g1 d']   ={'value':         1.824, 'min':  0.0 , 'max':    10,'fixed':True}

conf['params']['pdf-pion']['ubv1 N'] ={'value':0.838129163027, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['ubv1 a'] ={'value':        0.7301, 'min': -0.9 , 'max':     2,'fixed':False}
conf['params']['pdf-pion']['ubv1 b'] ={'value':         1.933, 'min':  0.0 , 'max':    10,'fixed':False}
conf['params']['pdf-pion']['ubv1 c'] ={'value':          13.8, 'min':  0.0 , 'max':    20,'fixed':True}
conf['params']['pdf-pion']['ubv1 d'] ={'value':           2.0, 'min':  0.0 , 'max':    10,'fixed':True}
...
conf['params']['pdf-pion']['dv1 c']  ={'value':     9.202e-01, 'min':  0.0 , 'max':    10,'fixed':'ubv1 c'}
conf['params']['pdf-pion']['dv1 d']  ={'value':     9.202e-01, 'min':  0.0 , 'max':    10,'fixed':'ubv1 d'}

conf['params']['pdf-pion']['u1 N']   ={'value':         0.417, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['u1 a']   ={'value':     0.207-1.0, 'min': -1.9 , 'max':     0,'fixed':True}
conf['params']['pdf-pion']['u1 b']   ={'value':         4.454, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['u1 c']   ={'value':        -2.466, 'min': -5.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['u1 d']   ={'value':         3.855, 'min':  0.0 , 'max':    10,'fixed':True}
...
conf['params']['pdf-pion']['db1 b']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}
conf['params']['pdf-pion']['db1 c']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 c'}
conf['params']['pdf-pion']['db1 d']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 d'}

conf['params']['pdf-pion']['s1 N']   ={'value':           0.0, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['s1 a']   ={'value':           0.0, 'min': -1.8 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['s1 b']   ={'value':           0.0, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['s1 c']   ={'value':           0.0, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['s1 d']   ={'value':           0.0, 'min':  0.0 , 'max':    10,'fixed':True}

conf['params']['pdf-pion']['sb1 N']  ={'value':    2.6720e-02, 'min':  0.0 , 'max':    10,'fixed':'s1 N'}
conf['params']['pdf-pion']['sb1 a']  ={'value':    -7.228e-01, 'min': -1.8 , 'max':    10,'fixed':'s1 a'}
conf['params']['pdf-pion']['sb1 b']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'s1 b'}
conf['params']['pdf-pion']['sb1 c']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'s1 c'}
conf['params']['pdf-pion']['sb1 d']  ={'value':    5.5854e+00, 'min':  0.0 , 'max':    10,'fixed':'s1 d'}
...
conf['steps'][1]={}
conf['steps'][1]['dep']=[]
conf['steps'][1]['active distributions']=['pdf-pion']
conf['steps'][1]['datasets']={}
conf['steps'][1]['datasets']['dy-pion']=[]
conf['steps'][1]['datasets']['dy-pion'].append(10001)
#conf['steps'][1]['datasets']['dy-pion'].append(10002)
#conf['steps'][1]['datasets']['dy-pion'].append(10003)

##--dy+ln
#conf['steps'][2]={}
#conf['steps'][2]['dep']=[1]
#conf['steps'][2]['active distributions']=['pdf-pion','p->pi,n']
#conf['steps'][2]['datasets']={}
#conf['steps'][2]['datasets']['dy-pion']=[]
#conf['steps'][2]['datasets']['dy-pion'].append(10001)
##conf['steps'][2]['datasets']['dy-pion'].append(10002)
##conf['steps'][2]['datasets']['dy-pion'].append(10003)
#conf['steps'][2]['datasets']['ln']=[]
#conf['steps'][2]['datasets']['ln'].append(1000)

##--dy+dy_pt
#conf['steps'][12]={}
#conf['steps'][12]['dep']=[11]
#conf['steps'][12]['active distributions']=['pdf-pion']
...
#conf['steps'][12]['datasets']['pion_qT']=[]
#conf['steps'][12]['datasets']['pion_qT'].append(1001)
#conf['steps'][12]['datasets']['pion_qT'].append(1002)
#
##--dy+dy_pt+ln
#conf['steps'][13]={}
#conf['steps'][13]['dep']=[12]
#conf['steps'][13]['active distributions']=['pdf-pion','p->pi,n']
...
#conf['steps'][13]={}
#conf['steps'][13]['dep']=[12]
#conf['steps'][13]['active distributions']=['pdf-pion']
#conf['steps'][13]['datasets']={}
#conf['steps'][13]['datasets']['dy-pion']=[]
#conf['steps'][13]['datasets']['dy-pion'].append(10001)
#conf['steps'][13]['datasets']['dy-pion'].append(10002)
...
#conf['steps'][14]['active distributions']=['pdf-pion','p->pi,n','pdf']
#conf['steps'][14]['passive distributions']=['pdf']
...
#conf['steps'][14]['datasets']['pion_qT']=[]
#conf['steps'][14]['datasets']['pion_qT'].append(1001)
#conf['steps'][14]['datasets']['pion_qT'].append(1002)
#conf['steps'][14]['datasets']['ln']=[]
#conf['steps'][14]['datasets']['ln'].append(1000)

##--dy+ln+dyqt(Q,XF)  mu=Q  pT>2.7
#conf['steps'][13]={}
...
##--.....
#conf['steps'][14]={}
#conf['steps'][14]['dep']=[11]
#conf['steps'][14]['active distributions']=['pdf-pion','p->pi,n']
#conf['steps'][14]['datasets']={}
#conf['steps'][14]['datasets']['dy-pion']=[]
#conf['steps'][14]['datasets']['dy-pion'].append(10001)
#conf['steps'][14]['datasets']['dy-pion'].append(10002)
