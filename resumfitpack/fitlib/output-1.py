...
conf['datasets']['dy-pion']['norm'][10001]={'value':    1.16842e+00,'fixed':False,'min':   0.5,'max':    1.5}
conf['datasets']['dy-pion']['norm'][10002]={'value':    9.55644e-01,'fixed':False,'min':   0.5,'max':    1.5}
conf['datasets']['dy-pion']['norm'][10003]={'value':    8.51739e-01,'fixed':False,'min':   0.5,'max':    1.5}
...
conf['params']['pdf-pion']['g1 N']   ={'value':    2.04980e-07, 'min':  0.0 , 'max':     1,'fixed':False}
conf['params']['pdf-pion']['g1 a']   ={'value':   -2.32100e-01, 'min': -1.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['g1 b']   ={'value':    1.08599e+00, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-pion']['ubv1 N'] ={'value':    1.03987e-01, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['ubv1 a'] ={'value':    9.36841e-01, 'min': -0.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['ubv1 b'] ={'value':    1.25384e+01, 'min':  0.0 , 'max':    10,'fixed':False}
conf['params']['pdf-pion']['ubv1 c'] ={'value':   -7.82315e+00, 'min':-10.0 , 'max':    10,'fixed':False,'zero':True}
conf['params']['pdf-pion']['ubv1 d'] ={'value':    2.00000e+00, 'min':  0.0 , 'max':    10,'fixed':True}

conf['params']['pdf-pion']['dv1 N']  ={'value':    1.03987e-01, 'min':  0.0 , 'max':    10,'fixed':'ubv1 N'}
conf['params']['pdf-pion']['dv1 a']  ={'value':    9.36841e-01, 'min': -1.8 , 'max':    10,'fixed':'ubv1 a'}
conf['params']['pdf-pion']['dv1 b']  ={'value':    1.25384e+01, 'min':  0.0 , 'max':    10,'fixed':'ubv1 b'}
conf['params']['pdf-pion']['dv1 c']  ={'value':   -7.82315e+00, 'min':-10.0 , 'max':    10,'fixed':'ubv1 c'}
conf['params']['pdf-pion']['dv1 d']  ={'value':    2.00000e+00, 'min':  0.0 , 'max':    10,'fixed':'ubv1 d'}

conf['params']['pdf-pion']['u1 N']   ={'value':    1.32004e-01, 'min':  0.0 , 'max':    10,'fixed':True}
conf['params']['pdf-pion']['u1 a']   ={'value':    2.08431e+00, 'min': -1.9 , 'max':     0,'fixed':False}
conf['params']['pdf-pion']['u1 b']   ={'value':    3.46864e+00, 'min':  0.0 , 'max':    10,'fixed':False}

conf['params']['pdf-pion']['db1 N']  ={'value':    1.32004e-01, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['db1 a']  ={'value':    2.08431e+00, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['db1 b']  ={'value':    3.46864e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}

conf['params']['pdf-pion']['s1 N']   ={'value':    1.32004e-01, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['s1 a']   ={'value':    2.08431e+00, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['s1 b']   ={'value':    3.46864e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}

conf['params']['pdf-pion']['sb1 N']  ={'value':    1.32004e-01, 'min':  0.0 , 'max':    10,'fixed':'u1 N'}
conf['params']['pdf-pion']['sb1 a']  ={'value':    2.08431e+00, 'min': -1.8 , 'max':    10,'fixed':'u1 a'}
conf['params']['pdf-pion']['sb1 b']  ={'value':    3.46864e+00, 'min':  0.0 , 'max':    10,'fixed':'u1 b'}
...
#conf['steps'][12]['active distributions']=['pdf','pdf-pion','p->pi,n']
...
#conf['steps'][12]={}
#conf['steps'][12]['dep']=[11]
#conf['steps'][12]['active distributions']=['pdf-pion','p->pi,n']
#conf['steps'][12]['datasets']={}
#conf['steps'][12]['datasets']['dy-pion']=[]
#conf['steps'][12]['datasets']['dy-pion'].append(10001)
#conf['steps'][12]['datasets']['dy-pion'].append(10002)
