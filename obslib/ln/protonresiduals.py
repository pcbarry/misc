...
class RESIDUALS(_RESIDUALS):
    ...
    def _get_theory(self,entry):
        ...
        if obs=='F2LN (valence)':
            ...
            conf['pdf'].storage[Q2]['qp'][1]=conf['pdf'].storage[Q2]['qm'][1]
            conf['pdf'].storage[Q2]['qp'][2]=conf['pdf'].storage[Q2]['qm'][2]
            for i in range(3,6):
                conf['pdf'].storage[Q2]['qp'][i]=np.zeros(len(conf['pdf'].storage[Q2]['qp'][i]))
            ...
            conf['pdf'].evolve(Q2)
            conf['pdf'].storage[Q2]['g']=np.zeros(len(conf['pdf'].storage[Q2]['g']))
            conf['pdf'].storage[Q2]['qp'][1]=2*conf['pdf'].storage[Q2]['ub']
            conf['pdf'].storage[Q2]['qp'][2]=2*conf['pdf'].storage[Q2]['db']
            thy=conf['ln'].get_F2LN(xpi,y,Q2,kT2max)
            del conf['pdf'].storage[Q2]
