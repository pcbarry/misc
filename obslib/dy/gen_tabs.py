...
import obslib.dy.piontheorynonplus
...
def gen_melltab():
    ...
    conf['dy-pion']=obslib.dy.piontheorynonplus.DY_PION_NON_PLUS()
    #conf['dy-pion']=obslib.dy.piontheorynlo.DY_PION_NLO()
...
if __name__=='__main__':
    ...
    #conf['datasets']['dy-pion']['xlsx'][61000]='dy-pion/expdata/61000.xlsx'
    #conf['datasets']['dy-pion']['xlsx'][80000]='dy-pion/expdata/80000.xlsx'
    #conf['datasets']['dy-pion']['xlsx'][50000]='dy-pion/expdata/50000.xlsx'
    #conf['datasets']['dy-pion']['xlsx'][90000]='dy-pion/expdata/90000.xlsx'
    conf['datasets']['dy-pion']['xlsx'][91000]='dy-pion/expdata/91000.xlsx'
